...
/*
	//function set - 8bit, 2 lines, inst table 1
	lcdControlWrite4(0x39);
	_delay_ms(2);
	lcdControlWrite4(0x39);
	lcdControlWrite4(0x39);
	lcdControlWrite4(0x29);
	lcdControlWrite(0x29);
	//bias set - 1/5, 3 line lcd
	lcdControlWrite(0x15);
	//power control - booster on, constrast C5,C4 (-1, +2)
	lcdControlWrite(0x55);
	//follower control
	lcdControlWrite(0x6D);
	//contrast set
	lcdControlWrite(0x78);
	//fuction set - inst table 0
	lcdControlWrite(0x28);
	//display on
	lcdControlWrite(0x0F);
	//clear display
	lcdControlWrite(0x01);
	//entry mode
	lcdControlWrite(0x06);
*/
	...
	/*
	lcdControlWrite(0x39);
	lcdControlWrite(0x14);
	lcdControlWrite(0x55);
	lcdControlWrite(0x6D);
	lcdControlWrite(0x78);
	lcdControlWrite(0x38);
	lcdControlWrite(0x0F);
	lcdControlWrite(0x01);
	lcdControlWrite(0x06);
	*/

	//return home - lcdControlWrite(0x02);
